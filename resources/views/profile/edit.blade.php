            ...
            <div class="card card-primary">
              ...
              <form role="form" action="{{route('profile.personal')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" name="name" value="{{ $user->name }}" placeholder="Enter Full Name" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="ic_number" class="form-control" name="ic_number" value="{{ $user->ic_number }}" placeholder="Enter IC Number" required>
                  </div>
                  
                  <div class="form-group">
                    <label for="phone_number">Phone Number</label>
                    <input type="phone_number" class="form-control" name="phone_number" value="{{ $user->phone_number }}" placeholder="Enter Phone Number" required>
                  </div>
                  <div class="form-group">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="{{route('profile.study')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="campus" class="form-control{{ $errors->has('campus') ? ' is-invalid' : '' }}" required>
                  ...
                  <div class="form-group">
                    ...
                    <select name="programme" class="form-control{{ $errors->has('programme') ? ' is-invalid' : '' }}" required>
                        <option value="" selected>Please Select</option>
            ...
            <div class="card card-primary">
              ...
              <input type="hidden" name="address_type" value="2">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" name="name" value="{{ @$father->name }}" placeholder="Enter Father Name" required>
                  </div>
                  <div class="form-group">
                    <label for="phone_number">Phone Number</label>
                    <input type="phone_number" class="form-control" name="phone_number" value="{{ @$father->phone_no }}" placeholder="Enter Father Number" required>
                  </div>
                <div class="form-group">
                    <label for="address_1">Address 1</label>
                    <input type="address_1" class="form-control" name="address_1" value="{{ @$father->address->address_1 }}" placeholder="Enter Address 1" required>
                  </div>
                  <div class="form-group">
                    <label for="address_2">Address 2</label>
                    <input type="address_2" class="form-control" name="address_2" value="{{ @$father->address->address_2 }}" placeholder="Enter Address 2" required>
                  </div>
                  <div class="form-group">
                    <label for="state">State</label>
                    <select name="state" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" required>
                  ...
                  <div class="form-group">
                    <label for="city">City</label>
                    <input type="city" class="form-control" name="city" value="{{ @$father->address->city }} "placeholder="Enter City" required>
                  </div>
                  <div class="form-group">
                    <label for="postcode">Postcode</label>
                    <input type="postcode" class="form-control" name="postcode" value="{{ @$father->address->postcode }}" placeholder="Enter Postcode" required>
                  </div>              
                </div>
                <!-- /.card-body -->
            ...
            <div class="card card-primary">
              ...
              <input type="hidden" name="address_type" value="3">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" name="name" value="{{ @$mother->name }}" placeholder="Enter Mother Name" required>
                  </div>
                  <div class="form-group">
                    <label for="phone_number">Phone Number</label>
                    <input type="phone_number" class="form-control" name="phone_number" value="{{ @$mother->phone_no }}" placeholder="Enter Phone Number" required>
                  </div>
                <div class="form-group">
                    <label for="address1">Address 1</label>
                    <input type="address1" class="form-control" name="address_1" value="{{ @$mother->address->address_1 }}" placeholder="Enter Address 1" required>
                  </div>
                  <div class="form-group">
                    <label for="address2">Address 2</label>
                    <input type="address2" class="form-control" name="address_2" value="{{ @$mother->address->address_2 }}" placeholder="Enter Address 2" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="city">City</label>
                    <input type="city" class="form-control" name="city" value="{{ @$mother->address->city }}" placeholder="Enter City" required>
                  </div>
                  <div class="form-group">
                    <label for="postcode">Postcode</label>
                    <input type="postcode" class="form-control" name="postcode" value="{{ @$mother->address->postcode }}" placeholder="Enter Postcode" required>
                  </div>              
                </div>
                <!-- /.card-body -->
